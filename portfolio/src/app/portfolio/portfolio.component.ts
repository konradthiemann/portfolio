...
projects = [
  {name:'Join', technologies:['JavaScript',' | ', 'HTML',' | ', 'CSS'], description:'Task manager inspired by the Kanban System. Create and organize tasks using drag and drop functions, assign users and categories.', url:['https://join.konrad-thiemann.de/', 'https://github.com/konradthiemann/join-portfolio'], img:'../../assets/img/portfolio-img/join.png'},
